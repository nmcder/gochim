...
export const honorificObject = defineRule({
    ...
    resolve(ctx) {
        ...
        return {
            ...
            explain: "주체 높임 '-시-'는 사람을 높일 때만 씁니다. 손님을 높이려는 마음은 알지만, 높임의 대상이 커피나 상품이 되어 버립니다.",
            refs: ['표준 언어 예절'],
        };
    },
    examples: [
...
export const honorificGyesida = defineRule({
    ...
    resolve(ctx) {
        ...
        return {
            ...
            explain: "말씀이나 질문은 사람이 아니므로 직접 높이지 않고, 그 주인을 높이는 간접 높임 '있으시다'를 씁니다. ('말씀이 있으시겠습니다')",
            refs: ['표준 언어 예절'],
        };
    },
    examples: [
...
export const honorificJeohuiNara = defineRule({
    ...
    resolve() {
        return {
            ...
            explain: "'저희'는 말하는 이가 자기 쪽을 낮출 때 씁니다. 나라는 듣는 이도 함께 속한 대상이라 낮출 수 없습니다. ('저희 회사·저희 학교'는 정상입니다)",
            refs: ['표준 언어 예절'],
        };
    },
    examples: [
...
export const honorificSilgeyo = defineRule({
    ...
    resolve() {
        return {
            ...
            explain: "'-ㄹ게요'는 말하는 이가 자기 의지를 밝히는 어미라서 '제가 할게요'처럼만 씁니다. 듣는 이에게 부탁·지시할 때는 '-세요'를 씁니다.",
        };
    },
...
export const honorificSelf = defineRule({
    ...
    resolve(ctx) {
        ...
        if (/께서|님이|님께서|니까|테니|으면|아서|어서/.test(middle))
            return null;
        return {
            suggestions: ['겠습니다'],
...
export const honorificTimeGreeting = defineRule({
    ...
    resolve(ctx) {
        ...
        return {
            ...
            explain: "'되세요'는 듣는 이가 그것이 되라는 뜻입니다. 시간을 보내는 것은 '보내세요'이고, 하루가 좋기를 바랄 때는 '좋은 하루 보내세요'로 씁니다.",
        };
    },
    examples: [{ wrong: '오늘 하루도 즐거운 시간 되세요.', right: '오늘 하루도 즐거운 시간 보내세요.' }],
});
export const honorificRules = [
    honorificObject,
    honorificCopula,
    honorificStock,
    honorificGyesida,
...
//# sourceMappingURL=honorific.js.map