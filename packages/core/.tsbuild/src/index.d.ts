...
export type { Analyzer, Category, CheckOptions, Diagnostic, Example, Finding, MorphFinding, MorphRule, MorphRuleContext, Morpheme, Rule, RuleContext, Severity, Word, } from './types.js';
 ...
 */
export declare function check(text: string, options?: CheckOptions): Diagnostic[];
/** 찾은 오류를 모두 첫 번째 제안으로 고친 문자열을 돌려준다. */
export declare function fix(text: string, options?: CheckOptions): string;
